...
if (isset($_POST['action'])) {
    ...
    switch ($_POST['action']) {
        case 'add':
            ...
            add($name,$image,$price,$qtn,$max,$tags,$sold,$brief,$detailed,$file_name);
            break;
...
function add($name,$image,$price,$qtn,$max,$tags,$sold,$brief,$detailed,$file_name) {
    ...
    if(doesProductExist($name)) {
        ...
        exit;
         ...
         try{
            insertProduct($name,$image,$price,$qtn,$max,$sold,$brief,$detailed,$file_name);
            $idProd = getProductId($name);
